    ...
    <Box ref={resumeRef} sx={style}>
      ...
      >
        ...
        <Text sx={{ fontSize: "0.9rem" }}>
          ...
          Features (Auto-Layout, Components, Variables, Smart Animation), Rapid
      ...
      >
        ...
        <Text sx={{ fontSize: "0.9rem" }}>
          Data Analysis (Data Dog, Statista), User Interviews, A/B Testing, User
          Research Reports, User Research Presentations.
        </Text>
      </Container>
      <Container
        sx={mobileContainerStyle}
